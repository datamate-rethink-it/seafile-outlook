 ...
 * Shared across all task panes.
 * Ported 1:1 from the Seafile Thunderbird extension.
 */
...
const FILE_ICONS = {
  folder:    `<svg ${SVG_ATTRS}><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" stroke="#e8a735" fill="#e8a735" fill-opacity="0.15"/></svg>`,
  folderUp:  `<svg ${SVG_ATTRS}><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" stroke="#e8a735" fill="#e8a735" fill-opacity="0.15"/><polyline points="12 17 12 11" stroke="#e8a735"/><polyline points="9 14 12 11 15 14" stroke="#e8a735"/></svg>`,
  ...
  video:     `<svg ${SVG_ATTRS}>${FILE_BASE}<polygon points="10 13 15 16 10 19" stroke="#3b82f6" fill="#3b82f6" fill-opacity="0.8"/></svg>`,
...
const STATUS_ICONS = {
  pending:  `<svg ${SVG_ATTRS} style="opacity:0.5"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
